...
# CORE GAMEPLAY LOOP
	# Use aggressive combat and possession to solve combat problems
	# Move through levels and unlock weapons/abilities

# gas puzzle should be in the main library
# so once you get the ability, you can move to another part of the castle.
